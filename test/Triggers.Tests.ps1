...
InModuleScope azure.datafactory.tools {
    ...
    Describe 'Publish trigger exists on both sides' -Tag 'Integration', 'triggers' {
        ...
        @{ Case = 'B08' ; DesiredState = 'Enabled' ; CurrentState = 'Disabled'; Mode = 'Excluded' ; StopStartTriggers = $true ; ShouldThrow = $false; TrExistsAfter = 1 ; StateAfter = 'Enabled' },
        @{ Case = 'B09' ; DesiredState = 'Disabled'; CurrentState = 'Enabled' ; Mode = 'Excluded' ; StopStartTriggers = $true ; ShouldThrow = $false; TrExistsAfter = 1 ; StateAfter = 'Disabled'},
    ...
    Describe 'Publish trigger exists in the source only' -Tag 'Integration', 'triggers' {
        ...
        Describe 'Publish trigger exists in target only' -Tag 'Integration', 'triggers' {
            ...
            @{ Case = 'T03' ; CurrentState = 'Enabled' ; Mode = 'Excluded' ; DeleteNIS = $false ; StopStartTriggers = $true ; ShouldThrow = $false; TrExistsAfter = 1 ; StateAfter = 'Disabled' },
            ...
            @{ Case = 'T07' ; CurrentState = 'Enabled' ; Mode = 'Excluded' ; DeleteNIS = $true  ; StopStartTriggers = $true ; ShouldThrow = $false; TrExistsAfter = 0 ; StateAfter = '' },
            @{ Case = 'T08' ; CurrentState = 'Disabled'; Mode = 'Excluded' ; DeleteNIS = $true  ; StopStartTriggers = $true ; ShouldThrow = $false; TrExistsAfter = 0 ; StateAfter = '' },
            ...
            @{ Case = 'T15' ; CurrentState = 'Enabled' ; Mode = 'Excluded' ; DeleteNIS = $true  ; StopStartTriggers = $false; ShouldThrow = $true ; TrExistsAfter = 1 ; StateAfter = 'Enabled' },
            @{ Case = 'T16' ; CurrentState = 'Disabled'; Mode = 'Excluded' ; DeleteNIS = $true  ; StopStartTriggers = $false; ShouldThrow = $false; TrExistsAfter = 0 ; StateAfter = '' }
